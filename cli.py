...
class ForumCLI(SimpleCLI):
    ...
    def run(self):
        ...
        print("Available commands: create_user, create_post, create_forum, get_users, get_posts, get_forums, update_user, update_post, update_forum, delete_user, delete_post, delete_forum, quit")
